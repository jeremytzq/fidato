...
const LEAD_COLS: ColDef<Lead>[] = [
  ...
  { key: 'property_type', label: 'Property Type', defaultVisible: true, render: l => l.property_type ? l.property_type.split(',').map(t => t.trim()).join(', ') : '—' },
...
const CLIENT_COLS: ColDef<Client>[] = [
  ...
  { key: 'property_type', label: 'Property Type', defaultVisible: true, render: c => c.property_type ? c.property_type.split(',').map(t => t.trim()).join(', ') : '—' },
